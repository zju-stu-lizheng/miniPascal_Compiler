...
public:
    AST_Assign_Statement(std::string _identifier1, AST_Expression *_expression1) : identifier1(_identifier1), expression1(_expression1), assign_type(Assign_Type::I_1_E_1) {}
    AST_Assign_Statement(std::string _identifier1, AST_Expression *_expression1, AST_Expression *_expression2) : identifier1(_identifier1), expression1(_expression1), expression2(_expression2), assign_type(Assign_Type::I_1_E_2) {}
    AST_Assign_Statement(std::string _identifier1, std::string _identifier2, AST_Expression *_expression1) : identifier1(_identifier1), identifier2(_identifier2), expression1(_expression1), assign_type(Assign_Type::I_2_E_1) {}
...
public:
    AST_Procedure_Statement(std::string _identifier) : identifier(_identifier), has_expression(Has_Expression::Not) {}
    AST_Procedure_Statement(std::string _identifier, AST_Expression_List *_expresion_list) : identifier(_identifier), expresion_list(_expresion_list), has_expression(Has_Expression::Yes) {}
...
public:
    ...
    AST_If_Statement(AST_Expression *_expression, AST_Statement *_statement, AST_Else_Clause *_else_clause) : expression(_expression), statement(_statement), else_clause(_else_clause) {}
};
...
public:
    ...
    AST_Case_Statement(AST_Expression *_expression, AST_Case_Expression_List *_case_expression_list) : expression(_expression), case_expression_list(_case_expression_list) {}
};
...
public:
    ...
    AST_Case_Expression(AST_Const_Value *_const_value, AST_Statement *_statement) : const_value(_const_value), statement(_statement), const_or_identifier(Const_or_Indentifier::CONST) {}
    AST_Case_Expression(std::string _identifier, AST_Statement *_statement) : identifier(_identifier), statement(_statement), const_or_identifier(Const_or_Indentifier::IDENTIFIER) {}
};
...
public:
    ...
    AST_Repeat_Statement(AST_Statement_List *_statement_list, AST_Expression *_expression) : statement_list(_statement_list), expression(_expression) {}
};
...
public:
    ...
    AST_While_Statement(AST_Expression *_expression, AST_Statement *_statement) : expression(_expression), statement(_statement) {}
};
